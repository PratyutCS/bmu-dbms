...
function btn1(i){
    if(i==1){
        ...
        document.querySelector(".sc2-2-1-linkLine-0").innerHTML = "2.1.1";
    }
    else if(i==2){
        ...
        document.querySelector(".sc1-2-txt6").style.color = "#797979";
        document.querySelector(".sc1-2-txt7").style.color = "#797979";
        document.querySelector(".sc2-2-1-linkLine-0").innerHTML = "2.1.2";
    }
    else if(i==3){
        document.querySelector(".sc1-2-btn1").classList.remove("sc1-2-btn-active");
        document.querySelector(".sc1-2-btn2").classList.remove("sc1-2-btn-active");
        ...
        document.querySelector(".sc1-2-txt6").style.color = "#797979";
        document.querySelector(".sc1-2-txt7").style.color = "#797979";
        document.querySelector(".sc2-2-1-linkLine-0").innerHTML = "3.1.4";
    }
    else if(i==4){
        document.querySelector(".sc1-2-btn1").classList.remove("sc1-2-btn-active");
        document.querySelector(".sc1-2-btn2").classList.remove("sc1-2-btn-active");
        ...
        document.querySelector(".sc1-2-txt6").style.color = "#797979";
        document.querySelector(".sc1-2-txt7").style.color = "#797979";
        document.querySelector(".sc2-2-1-linkLine-0").innerHTML = "3.4.3";
    }
    else if(i==5){
        document.querySelector(".sc1-2-btn1").classList.remove("sc1-2-btn-active");
        document.querySelector(".sc1-2-btn2").classList.remove("sc1-2-btn-active");
        ...
        document.querySelector(".sc1-2-txt6").style.color = "#797979";
        document.querySelector(".sc1-2-txt7").style.color = "#797979";
        document.querySelector(".sc2-2-1-linkLine-0").innerHTML = "3.7.1";
    }
    else if(i==6){
        document.querySelector(".sc1-2-btn1").classList.remove("sc1-2-btn-active");
        document.querySelector(".sc1-2-btn2").classList.remove("sc1-2-btn-active");
        ...
        document.querySelector(".sc1-2-txt7").style.color = "#797979";
        document.querySelector(".sc2-2-1-linkLine-0").innerHTML = "5.1.1";
    }
    else{
        document.querySelector(".sc1-2-btn1").classList.remove("sc1-2-btn-active");
        document.querySelector(".sc1-2-btn2").classList.remove("sc1-2-btn-active");
        ...
        document.querySelector(".sc2-2-1-linkLine-0").innerHTML = "5.1.4";
    }
}